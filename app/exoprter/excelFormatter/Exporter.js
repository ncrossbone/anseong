...
Ext.define("Ext.ux.exporter.Exporter", {
    uses: [
        "asSgis.exporter.ExporterButton",
        "asSgis.exporter.csvFormatter.CsvFormatter",
        "asSgis.exporter.excelFormatter.ExcelFormatter",
        "asSgis.exporter.FileSaver"],
    ...
    statics: {
        ...
        getFormatterByName: function(formatter) {
            ...
            formatter = !Ext.isString(formatter) ? formatter : Ext.create("asSgis.exporter." + formatter + "Formatter." + Ext.String.capitalize(formatter) + "Formatter");
            return formatter;
        }
    }
});